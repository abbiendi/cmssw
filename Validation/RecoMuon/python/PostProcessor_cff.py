...
postProcessorMuonTrackComp = cms.EDAnalyzer("DQMGenericClient",
    ...
    "Eff_GlbSta_Eta_mabh 'Eff_{GLB,STA} vs #eta' extractedGlobalMuons/effic_vs_eta standAloneMuons_UpdAtVtx/effic_vs_eta",
    "Eff_GlbSta_Pt_mabh 'Eff_{GLB,STA} vs p_{T}' extractedGlobalMuons/effic_vs_pt standAloneMuons_UpdAtVtx/effic_vs_pt",
